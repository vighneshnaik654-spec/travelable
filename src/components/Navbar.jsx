  ...
  return (
    <header className="bg-black shadow-sm sticky top-0 z-10">
      <nav aria-label="Main" className="max-w-6xl mx-auto flex items-center justify-between p-3">
        <Link to="/" className="text-xl font-bold text-teal-700">♿ TravelAble</Link>
        ...
        <ul id="menu" className={(open ? "block" : "hidden") + " absolute md:static top-14 left-0 right-0 bg-white p-3 md:p-0 md:flex md:items-center md:gap-1 shadow md:shadow-none"}>
