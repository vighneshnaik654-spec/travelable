...
export default function Home() {
  ...
  return (
    <div>
      <section className="bg-linear-to-br from-teal-200 to-teal-500 text-white p-8 md:p-16 text-center space-y-4">
        ...
        <form onSubmit={(e) => { e.preventDefault(); nav("/destinations?search=" + encodeURIComponent(q)); }} className="max-w-xl mx-auto flex gap-2">
          <label className="flex-1 text-left text-gray-400"><span className="sr-only">Where do you want to go?</span>
